...
useEffect (()=>{
  axios.get(`https://mhebackend.payagain.in/api/recharge`).then((res) => {
    const allData = res.data.filter((ele) => ele.user ===userRespons.user._id);
    let amount = 0;
    let expence = 0;
    if (allData.length > 0) {
      allData.forEach((item) => {
    ...
    axios
      ...
      .then((res) => {
        ...
        const retailerNotice=response.filter((item=>item.noticeFor=="Retailer"&& item.IsNoticeView==true))
  ...
  return (
    <Fragment>
      ...
      <Breadcrumb title="MESK HOLDER" parent="Retailer"/>
        ...
        <Row>
          ...
          <div className="time card-body">
            <div className="office animate-charcter">
              <b style={{ fontSize: "19px" }}>Office Timing</b>
              <div className="t1">
                <b>
                  Mon To Friday 10am to 6pm
                  <br />
                  (Sat -10am to 2pm)Lunch Time 1.30 to 2.30pm
                </b>
              </div>
            </div>
            <div className="money">
            ...
            <div className="support animate-charcter">
              ...
              <div className="t1">
                <b>
                  9209368085 / 9764931818 <br />
                  maharashrainformatics@gmail.com
                </b>
              </div>
            </div>
          </div>
