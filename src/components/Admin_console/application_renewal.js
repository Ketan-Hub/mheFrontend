...
function Application_renewal() {
  ...
  useEffect(() => {
    axios
      ...
      .catch((err) => console.log(err));
       axios
      .put(`https://mhebackend.payagain.in/api/renew/${id}`, {isNew:false})
      .then((res) => {
        dispatch(incNumber())
      })
      .catch((err) => console.log(err));
  ...
  const FormSubmit = (e) => {
    ...
    if (selectedItem.status === "IN-PROGRESS"||selectedItem.status==="IN-Progress") {
      ...
      axios
        .put(
          `https://mhebackend.payagain.in/api/renew_acknowledgmentDocument/${id}`,
          formData
        )
      ...
      axios
        .put(
          `https://mhebackend.payagain.in/api/renew/${id}`,
          obj
        )
        ...
        axios
      .put(`https://mhebackend.payagain.in/api/renew_finalDocument/${id}`, formData)
  ...
  if (selectedItem.application_type === "renew") {
    axios
      .put(`https://mhebackend.payagain.in/api/renew/${id}`, obj)
      .then((res) => {
                        ...
                        <div class="container-fluid px-4 mt-4">
                          <div class="formlayout">
                            ...
                            <div class="row g-3">
                              ...
                              <div class="col-md-6">
                                <label>
                                  <b>permanantsLicenceNo :</b>{" "}
                                </label>
                                <br />
                                {selectedItem.permanantsLicenceNo}{" "}
                              </div>
                              ...
                              <div class="col-md-6">
                                ...
                                >
                                  ...
                                  <a href={selectedItem.permanantDrivingLicence}>permanantDrivingLicence</a>
...
export default Application_renewal;