...
function Application_compGST() {
  ...
  const FormSubmit = (e) => {
    ...
    if (selectedItem.status === "IN-PROGRESS"||selectedItem.status==="IN-Progress") {
      ...
      axios
        .put(
          `https://mhebackend.payagain.in/api/compgst_acknowledgmentDocument/${id}`,
          formData
        )
      ...
      axios
        .put(
          `https://mhebackend.payagain.in/api/compgst/${id}`,
          obj
        )
        .then((res) => console.log("acknowledgmentDocument", res.data))
        .catch((err) => {
        ...
        axios
      .put(`https://mhebackend.payagain.in/api/compgst_finalDocument/${id}`, formData)
  ...
  if (selectedItem.application_type === "CompanyGST") {
    axios
      .put(`https://mhebackend.payagain.in/api/compgst/${id}`, obj)
      .then((res) => {
