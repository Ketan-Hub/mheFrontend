...
function Application_eGazzet() {
  ...
  const FormSubmit = (e) => {
    ...
    if (selectedItem.status === "IN-PROGRESS"||selectedItem.status==="IN-Progress") {
      ...
      axios
        .put(
          `https://mhebackend.payagain.in/api/gazzet_acknowledgmentDocument/${id}`,
          formData
        )
      ...
      axios
        .put(
          `https://mhebackend.payagain.in/api/e_gazzet/${id}`,
          obj
        )
        .then((res) => console.log("acknowledgmentDocument", res.data))
        .catch((err) => {
        ...
        axios
      .put(`https://mhebackend.payagain.in/api/gazzet_finalDocument/${id}`, formData)
  ...
  if (selectedItem.application_type === "e_gazzet") {
    axios
      .put(`https://mhebackend.payagain.in/api/e_gazzet/${id}`, obj)
      .then((res) => {
...
export default Application_eGazzet;