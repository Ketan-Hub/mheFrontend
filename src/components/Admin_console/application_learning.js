...
function Application_learning() {
  ...
  useEffect(() => {
    axios
      ...
      axios
      .put(`https://mhebackend.payagain.in/api/learning/${id}`, {isNew:false})
      .then((res) => {
        dispatch(incNumber())
      })
      .catch((err) => console.log(err));
  ...
  const FormSubmit = (e) => {
    ...
    if (selectedItem.status === "IN-PROGRESS"||selectedItem.status==="IN-Progress") {
      ...
      axios
        .put(
          `https://mhebackend.payagain.in/api/learning_acknowledgmentDocument/${id}`,
          formData
        )
      ...
      axios
        .put(
          `https://mhebackend.payagain.in/api/learning/${id}`,
          obj
        )
        .then((res) => console.log("acknowledgmentDocument", res.data))
        .catch((err) => {
        ...
        axios
      .put(`https://mhebackend.payagain.in/api/learning_finalDocument/${id}`, formData)
  ...
  if (selectedItem.application_type === "learning") {
    axios
                            ...
                            <div class="row g-3">
                              ...
                              <div class="col-md-6">
                                ...
                                >
                                  ...
                                  <a href={selectedItem.passportSize}>passportSize</a>
...
export default Application_learning;