...
function Application_permanent() {
  ...
  const FormSubmit = (e) => {
    ...
    if (selectedItem.status === "IN-PROGRESS"||selectedItem.status==="IN-Progress") {
      ...
      axios
        .put(
          `https://mhebackend.payagain.in/api/permanant_acknowledgmentDocument/${id}`,
          formData
        )
      ...
      axios
        .put(
          `https://mhebackend.payagain.in/api/permanant/${id}`,
          obj
        )
        .then((res) => console.log("acknowledgmentDocument", res.data))
        .catch((err) => {
        ...
        axios
      .put(`https://mhebackend.payagain.in/api/permanant_finalDocument/${id}`, formData)
  ...
  if (selectedItem.application_type === "parmanant") {
    axios
      .put(`https://mhebackend.payagain.in/api/permanant/${id}`, obj)
      .then((res) => {
