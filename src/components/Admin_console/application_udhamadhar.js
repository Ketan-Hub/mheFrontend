...
function Application_udhamadhar() {
  ...
  const FormSubmit = (e) => {
    ...
    if (selectedItem.status === "IN-PROGRESS"||selectedItem.status==="IN-Progress") {
      ...
      axios
        .put(
          `https://mhebackend.payagain.in/api/udhamAbhar_acknowledgmentDocument/${id}`,
          formData
        )
      ...
      axios
        .put(
          `https://mhebackend.payagain.in/api/udhamAbhar/${id}`,
          obj
        )
        ...
        axios
      .put(`https://mhebackend.payagain.in/api/udhamAbhar_finalDocument/${id}`, formData)
  ...
  if (selectedItem.application_type === "udhamAdhar") {
    axios
      .put(`https://mhebackend.payagain.in/api/udhamAbhar/${id}`, obj)
      .then((res) => {
...
export default Application_udhamadhar;