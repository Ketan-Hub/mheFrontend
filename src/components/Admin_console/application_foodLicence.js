...
function Application_foodLicence() {
  ...
  useEffect(() => {
    axios
      ...
      axios
      .put(`https://mhebackend.payagain.in/api/foodLicence/${id}`, {isNew:false})
      .then((res) => {
        dispatch(incNumber())
      })
      .catch((err) => console.log(err));
  ...
  const FormSubmit = (e) => {
    ...
    if (selectedItem.status === "IN-PROGRESS"||selectedItem.status==="IN-Progress") {
      ...
      axios
        .put(
          `https://mhebackend.payagain.in/api/foodLicence_acknowledgmentDocumentt/${id}`,
          formData
        )
      ...
      axios
        .put(
          `https://mhebackend.payagain.in/api/foodLicence/${id}`,
          obj
        )
        .then((res) => console.log("acknowledgmentDocument", res.data))
        .catch((err) => {
        ...
        axios
      .put(`https://mhebackend.payagain.in/api/foodLicence_finalDocument/${id}`, formData)
  ...
  if (selectedItem.application_type === "foodLicence") {
    axios
      .put(`https://mhebackend.payagain.in/api/foodLicence/${id}`, obj)
      .then((res) => {
                            ...
                            <div class="row g-3">
                              ...
                              <button
                                ...
                                >
                                  ...
                                  <a href={selectedItem.adharCard_businessOwner}>adharCard_businessOwner</a>
                                ...
                                >
                                  ...
                                  <a href={selectedItem.passportSize_Photo_businessOwner}>passportSize_Photo_businessOwner</a>
                                ...
                                >
                                  ...
                                  <a href={selectedItem.affidavitFrom_businessOwner}>affidavitFrom_businessOwner</a>
                                ...
                                >
                                  ...
                                  <a href={selectedItem.electricBill_businessPlace}>electricBill_businessPlace</a>
...
export default Application_foodLicence;