  ...
  const FormSubmit=(e)=>{
    ...
    e.preventDefault()
      ...
      if (selectedItem.status === "IN-PROGRESS"||selectedItem.status==="IN-Progress") {
        ...
        axios
          .put(
            `https://mhebackend.payagain.in/api/EWS_acknowledgmentDocument/${id}`,
            formData
          )
        ...
        axios
          .put(
            `https://mhebackend.payagain.in/api/Ews/${id}`,
            obj
          )
          .then((res) => console.log("acknowledgmentDocument", res.data))
          .catch((err) => {
          ...
          axios
        .put(`https://mhebackend.payagain.in/api/EWS_finalDocument/${id}`, formData)
